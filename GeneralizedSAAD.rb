class Saad
  ...
  def self.mechanic_prediction
    ...
    #Maisettelingua::LinguaFranca.ouvert("dice/dice_selection/dice_rolls.txt",                             "#{d1}",
    #                                    "dice/dice_probability/dice_rolls.txt",                           "#{d2}",
    #                                    "dice/dice_matrix_probability/dice_rolls.txt", "#{selection_probability}")
  end
